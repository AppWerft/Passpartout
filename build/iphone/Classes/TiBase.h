...
// in simulator we redefine to format for Passpartout Developer console
...
{\
	NSString * exceptionName = [@"org.passpartout." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.passpartout";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPasspartoutNativeItemNone = -1, 
	UIPasspartoutNativeItemSpinner = -2,
	UIPasspartoutNativeItemProgressBar = -3,
	
	UIPasspartoutNativeItemSlider = -4,
	UIPasspartoutNativeItemSwitch = -5,
	UIPasspartoutNativeItemMultiButton = -6,
	UIPasspartoutNativeItemSegmented = -7,
	
	UIPasspartoutNativeItemTextView = -8,
	UIPasspartoutNativeItemTextField = -9,
	UIPasspartoutNativeItemSearchBar = -10,
	
	UIPasspartoutNativeItemPicker = -11,
	UIPasspartoutNativeItemDatePicker = -12,
	
	UIPasspartoutNativeItemInfoLight = -13,
	UIPasspartoutNativeItemInfoDark = -14,
	
	UIPasspartoutNativeItemDisclosure = -15,
	
	UIPasspartoutNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Passpartout instances of
