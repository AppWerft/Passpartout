...
/**
 Base class for all Passpartout views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Passpartout view hierarchy (such as wrapped iOS UIViews) was touched.
