...
//@interface PasspartoutObject : NSObject
//@end

@interface PasspartoutObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PasspartoutObject class]])
		{
			for (NSString *key in [[(PasspartoutObject*)o modules] allKeys])
			{
