...
@interface PasspartoutObject : KrollCoverageObject {
#else
@interface PasspartoutObject : KrollObject {
#endif
@private
...
extern NSString * Passpartout$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PasspartoutObject *_passpartout;
    KrollObject* console;
	BOOL shutdown;
